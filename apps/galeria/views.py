...
def editar_imagem(request, foto_id):
    ...
    return render(request, 'galeria/editar_imagem.html', {'form': form, 'foto_id': fotografia.id})
...
def filtro(request, categoria):
    ...
    return render(request, 'galeria/filtro.html', {'cards': fotografias, 'categoria': categoria})